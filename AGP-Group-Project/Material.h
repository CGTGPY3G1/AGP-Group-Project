#pragma once
#ifndef B00289996B00227422_MATERIAL_H
#define B00289996B00227422_MATERIAL_H
#include "Texture.h"
#include "Mesh.h"
#include <memory>
namespace B00289996B00227422 {
	...
	public:
		...
		/// <param name="toAdd">the new texture.</param>
		...
		/// <summary> Binds the material using either to it's own shader or the one provided.</summary>
		/// <param name="differentShader">an optional shader value.</param>
...
#endif // !B00289996B00227422_MATERIAL_H
